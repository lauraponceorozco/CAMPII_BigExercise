...
1. Establish the Baseline Pipeline: prove the model works as intended on clean data. Compute Baseline Metrics, Dice Similarity Coefficient (DSC). Visual check. Install an Extension: Search the VS Code Marketplace for "NIfTI" or "Niivue".
